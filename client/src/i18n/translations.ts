export const translations = {
  ru: {
    ...
    "roi.calculator.roomsTooltip": "Введите количество номеров в отеле. Расчет использует те же значения на номер в месяц, что и основной ROI-калькулятор.",
    "roi.calculator.roomsUnit": "номеров",
    "roi.calculator.roomsMin": "5 номеров",
    "roi.calculator.roomsMid": "250 номеров",
    "roi.calculator.roomsMax": "500 номеров",
    "roi.calculator.editRooms": "Нажмите, чтобы изменить",
    "roi.calculator.totalImpact": "Общий эффект",
    "roi.calculator.additionalPotentialRevenue": "Дополнительный потенциальный доход",
    "roi.calculator.monthlyIncome": "Месячный дополнительный доход",
    "roi.calculator.annualIncome": "Годовой дополнительный доход",
    "roi.calculator.breakdownTitle": "Детализация дохода",
    "roi.calculator.breakdownSubtitle": "Из чего складывается рост",
    ...
    "roi.calculator.estimatedRoi": "Расчетный ROI",
    "roi.calculator.growth": "Рост",
    "roi.calculator.monthShort": "месяц",
    "roi.calculator.showDetails": "Детали расчета",
    "roi.calculator.hideDetails": "Скрыть детали",
    "roi.calculator.ctaTitle": "Готовы увеличить доход вашего отеля?",
    "roi.calculator.ctaText": "Получите детальную персональную разбивку под ваш отель от нашей команды.",
    ...
    formula_explanation_main: "Мы берём количество номеров и умножаем его на три источника эффекта: €53 экономии OTA-комиссий, €80 F&B через онлайн-меню и €50 upsell на номер в месяц.",
    formula_explanation_additional: "Месячный эффект = номера × €183. Годовой эффект = месячный эффект × 12.",
    ...
    price_basic: "$509",
    plan_basic_limits: "8 050 сообщений",
    plan_basic_limits_array: ["8 050 сообщений"],
    plan_basic_overage: "После: за каждые 1000 сообщений - 12$",
    plan_pro_limits: "13 800 сообщений",
    plan_misterio_limits_array: ["23 000 сообщений"],
  ...
  ua: {
    ...
    "roi.calculator.roomsTooltip": "Введіть кількість номерів у готелі. Розрахунок використовує ті самі значення на номер на місяць, що й основний ROI-калькулятор.",
    "roi.calculator.roomsUnit": "номерів",
    "roi.calculator.roomsMin": "5 номерів",
    "roi.calculator.roomsMid": "250 номерів",
    "roi.calculator.roomsMax": "500 номерів",
    "roi.calculator.editRooms": "Натисніть, щоб змінити",
    "roi.calculator.totalImpact": "Загальний ефект",
    "roi.calculator.additionalPotentialRevenue": "Додатковий потенційний дохід",
    "roi.calculator.monthlyIncome": "Місячний додатковий дохід",
    "roi.calculator.annualIncome": "Річний додатковий дохід",
    "roi.calculator.breakdownTitle": "Деталізація доходу",
    "roi.calculator.breakdownSubtitle": "Звідки береться зростання",
    ...
    "roi.calculator.estimatedRoi": "Розрахунковий ROI",
    "roi.calculator.growth": "Зростання",
    "roi.calculator.monthShort": "місяць",
    "roi.calculator.showDetails": "Деталі розрахунку",
    "roi.calculator.hideDetails": "Сховати деталі",
    "roi.calculator.ctaTitle": "Готові збільшити дохід вашого готелю?",
    "roi.calculator.ctaText": "Отримайте детальну персональну розбивку під ваш готель від нашої команди.",
    ...
    formula_explanation_main: "Ми беремо кількість номерів і множимо її на три джерела ефекту: €53 економії OTA-комісій, €80 F&B через онлайн-меню та €50 upsell на номер на місяць.",
    formula_explanation_additional: "Місячний ефект = номери × €183. Річний ефект = місячний ефект × 12.",
    ...
    price_basic: "$509",
    plan_basic_limits: "8 050 повідомлень",
    plan_basic_limits_array: ["8 050 повідомлень"],
    plan_basic_overage: "Після: за кожні 1000 повідомлень - 12$",
    plan_pro_limits: "13 800 повідомлень",
    plan_misterio_limits_array: ["23 000 повідомлень"],
  ...
  en: {
    ...
    "roi.calculator.roomsTooltip": "Enter the number of rooms in your hotel. The calculation uses the same per-room monthly values as the main ROI calculator.",
    "roi.calculator.roomsUnit": "rooms",
    "roi.calculator.roomsMin": "5 Rooms",
    "roi.calculator.roomsMid": "250 Rooms",
    "roi.calculator.roomsMax": "500 Rooms",
    "roi.calculator.editRooms": "Click to edit",
    "roi.calculator.totalImpact": "Total Impact",
    "roi.calculator.additionalPotentialRevenue": "Additional potential revenue",
    "roi.calculator.monthlyIncome": "Monthly Additional Income",
    "roi.calculator.annualIncome": "Annual Additional Income",
    "roi.calculator.breakdownTitle": "Revenue Breakdown",
    "roi.calculator.breakdownSubtitle": "Where your growth comes from",
    ...
    "roi.calculator.estimatedRoi": "Estimated ROI",
    "roi.calculator.growth": "Growth",
    "roi.calculator.monthShort": "month",
    ...
    "roi.calculator.ctaText": "Get a detailed, personalized breakdown for your specific hotel needs from our expert team.",
    ...
    formula_explanation_main: "We multiply your room count by three effect sources: €53 OTA commission savings, €80 F&B via online menu, and €50 upsell per room per month.",
    formula_explanation_additional: "Monthly impact = rooms × €183. Annual impact = monthly impact × 12.",
    ...
    price_basic: "$509",
    plan_basic_limits: "8,050 messages",
    plan_basic_limits_array: ["8,050 messages"],
    plan_basic_overage: "After: for every 1000 messages - 12$",
    plan_pro_limits: "13,800 messages",
    plan_misterio_limits_array: ["23,000 messages"],
  ...
  pl: {
    ...
    "roi.calculator.roomsTooltip": "Wprowadź liczbę pokoi w hotelu. Kalkulacja używa tych samych miesięcznych wartości na pokój co główny kalkulator ROI.",
    "roi.calculator.roomsUnit": "pokoi",
    "roi.calculator.roomsMin": "5 pokoi",
    "roi.calculator.roomsMid": "250 pokoi",
    "roi.calculator.roomsMax": "500 pokoi",
    "roi.calculator.editRooms": "Kliknij, aby edytować",
    "roi.calculator.totalImpact": "Łączny efekt",
    "roi.calculator.additionalPotentialRevenue": "Dodatkowy potencjalny przychód",
    "roi.calculator.monthlyIncome": "Miesięczny dodatkowy dochód",
    "roi.calculator.annualIncome": "Roczny dodatkowy dochód",
    "roi.calculator.breakdownTitle": "Rozliczenie przychodów",
    "roi.calculator.breakdownSubtitle": "Skąd pochodzi wzrost",
    ...
    "roi.calculator.estimatedRoi": "Szacowany ROI",
    "roi.calculator.growth": "Wzrost",
    "roi.calculator.monthShort": "miesiąc",
    ...
    "roi.calculator.ctaText": "Otrzymaj szczegółową, spersonalizowaną analizę dla swojego hotelu od naszego zespołu.",
    ...
    formula_explanation_main: "Mnożymy liczbę pokoi przez trzy źródła efektu: €53 oszczędności na prowizjach OTA, €80 F&B przez menu online i €50 upsell na pokój miesięcznie.",
    formula_explanation_additional: "Efekt miesięczny = pokoje × €183. Efekt roczny = efekt miesięczny × 12.",
    ...
    price_basic: "$509",
    plan_basic_limits: "8 050 wiadomości",
    plan_basic_limits_array: ["8 050 wiadomości"],
    plan_basic_overage: "Potem: za każde 1000 wiadomości - 12$",
    plan_pro_limits: "13 800 wiadomości",
    plan_misterio_limits_array: ["23 000 wiadomości"],
