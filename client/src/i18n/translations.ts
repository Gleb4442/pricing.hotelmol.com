export const translations = {
  ru: {
    ...
    plan_misterio_description: "Система Ritz-Carlton",
  ...
  en: {
    ...
    plan_misterio_title: "ULTRA",
    plan_misterio_description: "Ritz-Carlton System",
    plan_premium_title: "ENTERPRISE",
  ...
  pl: {
    ...
    plan_misterio_title: "ULTRA",
    plan_misterio_description: "System Ritz-Carlton",
    ...
    price_basic: "$99",
    plan_basic_limits: "75 czatów ≈ 1500 wiadomości ≈ 75 000 znaków",
    plan_basic_limits_array: ["1500 wiadomości"],
    plan_basic_overage: "Potem: za każde 1000 wiadomości - 12$",
    plan_pro_limits: "5000 wiadomości",
