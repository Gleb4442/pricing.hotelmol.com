          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-card border border-border rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-muted-foreground">
                Подключаемся к вашему PMS и каналам через API. Базовый запуск занимает 1–3 рабочих дня и не мешает работе ресепшна. Ассистент бережно соблюдает политики тарифов, стоп-сейлы и правила отмен. Права доступа — минимально необходимые, вся передача данных шифруется.
              </p>
            </div>
            <div className="bg-card border border-border rounded-2xl p-6 shadow-lg">
              <h4 className="text-lg font-semibold text-foreground mb-2">
